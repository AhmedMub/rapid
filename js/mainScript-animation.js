...
let featuresSec2Observer = new IntersectionObserver(
  (entries, featuresSec2Observer) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        anime({
...
let pricingSecObserver = new IntersectionObserver(
  (entries, pricingSecObserver) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        //animate boxes
        anime({
